...
# 下面这两行代码可能出错，因为 su_puzzle 没有定义过，我猜测你可能想复制变量 puzzle 到 su_contour_1 和 su_contour_2。 
su_contour_1= su_puzzle.copy()
su_contour_2= sudoku_a.copy()

su_contour, hierarchy = cv2.findContours(su_puzzle, cv2.RETR_EXTERNAL, cv2.CHAIN_APPROX_SIMPLE)  # 这里 su_puzzle 没有定义
